...
router.route('/experience').put(protect, addWorkExperience)
router.route('/experience').delete(protect, deleteWorkExperience)

router.route('/education').put(protect, updateEducationDetails)
router.route('/education').delete(protect, deleteEducationDetails)

router.route('/github/:username').get(protect, getUserRepositories)
